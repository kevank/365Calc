...
export default function OrganizationProfile({ userCount, setUserCount, monthlyCost, setMonthlyCost, annualSpend }) {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
        <div>
          <label className="flex items-center gap-1.5 text-sm text-gray-600 mb-2">
            ...
            Number of Business Premium Users
          </label>
          <input
            type="number"
            value={userCount}
        ...
        <div>
          <label className="text-sm text-gray-600 mb-2 block">BP Monthly Cost (per user)</label>
        ...
        <div>
          <label className="text-sm text-gray-600 mb-2 block">Annual BP Spend</label>
