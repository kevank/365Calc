      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-800 text-lg">Executive Summary</span>
          </div>
          <button
            onClick={onBack}
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mt-8 shadow-sm">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li className="flex items-start gap-2">
              <svg className="w-5 h-5 text-[#1a56db] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
